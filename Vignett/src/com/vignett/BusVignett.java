...
public class BusVignett extends Vignett {

	private static final double PRICE_PER_DAY = 9.0;
	private static final double PRICE_PER_MONTH = PRICE_PER_DAY * 10;
	private static final double PRICE_PER_YEAR = PRICE_PER_MONTH * 6;

	public BusVignett(String type) throws InvalidVignettException {
		super("yellow");
		setVignettType(type);
	}
